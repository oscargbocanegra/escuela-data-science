...
- [Basic python](#Basic-python)
    ...
    - [Características delos algoritmos](#Características-de-los-algoritmos)
...
___
## Que es un algoritmo
- Es una serie de pasos finitos y NO ambiguos para resolver algo.
___
## Para qué sirven
...
___
## Que es una variable
- Es una caja donde puedes guardar algo (dato, objeto) y tiene un identificador.
